      ...
      <List>
        ...
        <Collapse in={openUser} timeout="auto" unmountOnExit>
          <List component="div" disablePadding>
            <ListItem sx={{ pl: 4 }}>
              <ListItemIcon onClick={() => routToPage("/profile")}>
                <ListAlt sx={{ color: "white" }} />
              </ListItemIcon>
              {drawerOpen && <ListItemText primary="Details" sx={{ color: "white" }} />}
            </ListItem>
          </List>
        </Collapse>
        ...
        <Collapse in={openBooks} timeout="auto" unmountOnExit>
          <List component="div" disablePadding>
            <ListItem sx={{ pl: 4 }}>
              <ListItemIcon onClick={() => routToPage("/ublist")}>
                <ListAlt sx={{ color: "white" }} />
              </ListItemIcon>
        ...
        <Collapse in={openIssued} timeout="auto" unmountOnExit>
          <List component="div" disablePadding>
            <ListItem sx={{ pl: 4 }}>
              <ListItemIcon onClick={() => routToPage("/ubilist")}>
                <ListAlt sx={{ color: "white" }} />
              </ListItemIcon>
